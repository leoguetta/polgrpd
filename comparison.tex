...
\begin{proof}
  ...
  square on the right are isomorphisms by \cref{lemma:colim}. The far left
  vertical arrow is an isomorphism because the natural transformation
  $\tr{\frgp P\!}{-} \to \tr{C}{-}$ is a pointwise weak equivalence by
  stability of trivial fibrations under pullback, and homotopy colimits
  send pointwise weak equivalences to isomorphisms (in the homotopy category). Finally, the top
