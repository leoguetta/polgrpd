...
\newtheorem{openquestion}[subsubsection]{Open question}
...
\newcommand{\emb}[2]{\functor{j}_{#1}^{#2}}%inclusion from (oo,#1)-cat to (oo,#2)-cat
\newcommand{\pifun}[2]{\functor{\pi}_{#1}^{#2}}%left adjoint of the
                                %above
\newcommand{\maxgr}[2]{\functor{\iota}_{#1}^{#2}}%right-adjoint to
                                %\emb
...
\newcommand{\abelk}[1]{\functor{\abel}_{\pair{\oo}{#1}}}%Abelianization functor from dim #1
...
\newcommand{\grayk}[1]{\underset{{\pair{\oo}{#1}}}{\gray}} %Gray tens product
...
\newcommand{\Hop}[1]{\Ho^{\pair{\oo}{#1},\mathrm{pol}}} %Polygraphic homology

\newcommand{\Derp}[1]{\functor{D}_{\geq 0}(#1)}
\newcommand{\Loc}[1]{\mathrm{Ho}(#1)} %Homotopy categories

\DeclareMathOperator*{\hoilim}{\mathrm{ho}\underset{\longrightarrow}{\mathrm{lim}}} % limit
%\newcommand{\hoilim}{\DeclareMathOperator{\overset{\mathrm{holim}}{\longleftarrow}}} % colimit
...
\newcommand{\fmcomment}[1]{
    \marginpar{\tiny\textcolor{red}{FM: #1}}}
