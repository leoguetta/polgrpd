...
\newcommand{\hoilim}{\underset{\longrightarrow}{\mathrm{holim}}} % colimit
\DeclareMathOperator{\hocolim}{\underset{\longrightarrow}{\mathrm{holim}}} % limit
%\newcommand{\hocolim}{\DeclareMathOperator{\underset{\longrightarrow}{\mathrm{holim}}}}
\newcommand{\GZ}[1]{\overline{#1}} %Functor induced by localization

\newlength{\mylen}
\settowidth{\mylen}{\text{xxxi}}

\newcommand{\extarrow}{\begin{tikzpicture}
      \draw[->] (0,0) -- (\mylen,0) ;
    \end{tikzpicture}}

\newcommand{\varhocolim}[1]{\underset{\extarrow #1}{\mathrm{holim}}} 
