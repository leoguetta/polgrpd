...
This allows for a
  simplification of certain coherence issues: $G$ induces a \emph{unique} functor $\GZ{G}$ at the level of
...
p_{I!}$ is nothing but the \emph{homotopy colimit functor}
  ...
  \]
  % \[
  %   \underset{\longrightarrow I}{\mathrm{holim}}\colon \Loc{\fun{I}{\M}} \to \Loc{\M}
  % \]
...
\begin{remark}
  ...
  referred as the fact that \emph{left Quillen functors preserve
...
\begin{definition}\label{def:abstracthom}
  ...
  \[
    \Ho_{\M}(I,X):=\LL p_{I!}X=\varhocolim I X.
  \]
\end{definition}
