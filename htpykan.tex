...
\begin{paragr}
  ...
  preserves \emph{all} weak equivalences. This property allows for a
  simplification of certain coherence issues. Because $G$ preserves
  all weak equivalences, it induces a functor $\GZ{G}$ at the level of
  homotopy categories such that the following square is
  \emph{commutative}
  \[
...
\Loc{\M'},
  ...
  to weak equivalences in the sense of Gabriel--Zisman \cite{}, and
  the vertical arrows are the localization functor. It follows
\end{paragr}
