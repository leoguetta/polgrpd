...
\begin{paragr}
  ...
  preserves \emph{all} weak equivalences. This allows for a
...
\Loc{\M'},
  ...
  the vertical arrows are the localization functor. It follows from
  ...
  any natural transformation $\beta \colon F \Rightarrow F'$ a natural
  transformation $\LL \beta \colon \LL F \Rightarrow \LL F'$, the
  ...
  data which makes some proofs uneasy.

  The upshot is that since each 
    \end{paragr}
