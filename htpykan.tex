...
\ar[from=3-2,to=B,Rightarrow,"\epsilon"]
    \end{tikzcd}
  \]
  This, in turn, allows one to define a canonical natural transformation
  \[
...
\begin{paragr}
  ...
  \]
  By co-end calculus, if we take $N=\cst{\Z}$ then we have a
  natural isomorphism
  \[
  ...
  \[
    \Ho_n(C)\simeq \Tor{C}{n}(\cst{\Z},\cst{\Z}).
  \]
