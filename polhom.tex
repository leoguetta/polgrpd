...
\end{equation}
which is \emph{a priori} not an isomorphism.
...
\]
\end{paragr}
\begin{openquestion} Is the natural transformation
  \eqref{transnat} an isomorphism?
\end{openquestion}
As we shall see at the end of this section, we answer positively to
the above open question in a very particular subcase. Without a
general answer though, we are led to make the following definition.
\begin{definition}
